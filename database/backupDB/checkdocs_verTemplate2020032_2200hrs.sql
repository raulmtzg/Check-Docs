...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-03-2020 a las 04:45:26
...
INSERT INTO `documentos` (`iddocumento`, `codigodocumento`, `nombredocumento`, `tipodocumento`, `estado`, `version`, `condicion`, `usuarioresponsable`, `fechaultimarevision`, `nombrearchivo`, `conruta`, `usuarioalta`, `fechaalta`, `usuariomodificacion`, `fechamodificacion`, `restaurado`, `usuariorestauracion`, `fecharestauracion`, `enpapelera`, `idusuarioresponsable`, `idsubproceso`, `idtipodocumento`, `idsuscriptor`) VALUES
(1, 'SIST-01', 'PROCEDIMIENTO SISTEMAS', 'PROCEDIMIENTO', 'EN EDICIÓN', '1', 1, 'RAUL MARTINEZ GONZALEZ', '2019-04-09', '1-5cac0aa91e9ae.docx', 0, 'RMARTINEZ', '2019-04-09 04:59:00', NULL, NULL, 0, NULL, NULL, 0, 3, 2, 1, 1),
(2, 'SIST-02', 'INDICADORES', 'PROCEDIMIENTO', 'EN EDICIÓN', '2', 1, 'RAUL MARTINEZ GONZALEZ', '2019-04-09', '1-5cac20697f0f4.docx', 0, 'RMARTINEZ', '2019-04-09 06:32:00', NULL, NULL, 0, NULL, NULL, 0, 3, 2, 1, 1),
(3, '3004', 'INDICADORES DE SISTEMAS', 'PROCEDIMIENTO', 'EN EDICIÓN', '0', 1, 'RAUL MARTINEZ GONZALEZ', '2019-05-01', '1-5cc8fe4cdb3c0.docx', 0, 'RMARTINEZ', '2019-05-01 04:02:00', NULL, NULL, 0, NULL, NULL, 0, 3, 2, 1, 1),
(4, 'SIST-03', 'FORMATO COMPRAS', 'PROCEDIMIENTO', 'EN EDICIÓN', '1', 1, 'JULIO ROBLES  SUAREZ', '2019-05-24', '1-5ce7436b64e65.pdf', 0, 'RMARTINEZ', '2019-05-24 03:05:00', NULL, NULL, 0, NULL, NULL, 0, 7, 2, 1, 1);
...
(1, 'SISTEMAS', 1, 1, 1, '5c25b1364265d', 'RMARTINEZ', '2018-12-28 06:14:00', 'RMARTINEZ', '2018-12-28 06:15:00', '2019-01-23 08:54:00', 'RMARTINEZ', 1),
(2, 'ADMIN', 1, 1, 1, '5c25b149bff89', 'RMARTINEZ', '2018-12-28 06:14:00', 'RMARTINEZ', '2018-12-28 06:37:00', '2019-01-23 09:15:00', 'RMARTINEZ', 1),
...
(5, 'BASCULA', 1, 1, 1, '5c25b1cf24058', 'RMARTINEZ', '2018-12-28 06:17:00', 'RMARTINEZ', '2018-12-28 06:37:00', '2019-12-14 16:41:00', 'RMARTINEZ', 1);
...
(2, 'PROCESO SISTEMAS', 1, 1, '5c25b136c0edb', 1, 'RMARTINEZ', '2018-12-28 06:14:00', 'RMARTINEZ', '2019-04-09 03:38:00', NULL, NULL, 1),
...
(23, 'B3', 0, 3, '5c25b1efcf707', 1, 'RMARTINEZ', '2018-12-28 06:17:00', 'RMARTINEZ', '2020-03-04 05:32:00', NULL, NULL, 5);
...
(1, 'SACSI WEB', 'ABCDE', 5, 5, NULL, NULL, '2721289117', '300', 'sacsi', 'SISTEMA DE GESTION SGI', 'AQUÍ ENCONTRARAS LA DOCUMENTACIÓN NECESARIA PARA EL SISTEMA DE GESTIÓN EN SACSI', 'views/img/sacsi/logo_sacsi.jpg', 1, '2018-11-08 05:06:00', 'SISTEMA', '2018-11-20 05:37:00', 'SISTEMA'),
...
INSERT INTO `tipodocumento` (`idtipodocumento`, `descripcion`, `usuarioalta`, `fechaalta`, `usuariomodificacion`, `fechamodificacion`, `condicion`, `idsuscriptor`) VALUES
(1, 'PROCEDIMIENTO', 'RMARTINEZ', '2019-03-24 01:24:00', 'RMARTINEZ', '2019-03-31 00:30:00', 1, 1),
(2, 'PROCESO', 'RMARTINEZ', '2020-02-20 03:11:00', 'RMARTINEZ', '2020-02-20 03:53:00', 1, 1);
...
(3, 'RAUL MARTINEZ GONZALEZ', 'RMARTINEZ', '240be518fabd2724ddb6f04eeb1da5967448d7e831c08c8fa822809f74c720a9', 1, 'raul.martinez@sacsi.com.mx', NULL, 0, 1, '2018-11-11 04:48:00', 'SISTEMA', NULL, NULL, 1),
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vwopciones_menu`  AS  select `procesos`.`idsuscriptor` AS `idsuscriptor`,`procesos`.`idproceso` AS `idproceso`,`procesos`.`descripcion` AS `proceso`,`procesos`.`publicar` AS `publicar`,`procesos`.`condicion` AS `condicionproceso`,`subprocesos`.`idsubproceso` AS `idsubproceso`,`subprocesos`.`descripcion` AS `subproceso`,`subprocesos`.`condicion` AS `condicionsubproceso`,`subprocesos`.`consecutivo` AS `consecutivo`,`subprocesos`.`identificadorsubproceso` AS `identificadorsubproceso`,`subprocesos`.`archivocreado` AS `archivocreado` from (`procesos` join `subprocesos` on((`procesos`.`idproceso` = `subprocesos`.`idproceso`))) ;
...
ALTER TABLE `documentos`
  ...
  ADD KEY `fk_documentos_suscriptores1_idx` (`idsuscriptor`);
...
ALTER TABLE `tipodocumento`
  ...
  ADD KEY `fk_tipodocumento_suscriptores1_idx` (`idsuscriptor`);
...
ALTER TABLE `documentos`
  ...
  ADD CONSTRAINT `fk_documentos_suscriptores1` FOREIGN KEY (`idsuscriptor`) REFERENCES `suscriptores` (`idsuscriptor`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `tipodocumento`
  ADD CONSTRAINT `fk_tipodocumento_suscriptores1` FOREIGN KEY (`idsuscriptor`) REFERENCES `suscriptores` (`idsuscriptor`) ON DELETE NO ACTION ON UPDATE NO ACTION;
